...
with open('my_notes.txt', 'w') as file:
    ...
    file.write("Nota 9: Llama a papá.\n")
    file.write("Nota 2: Termina el proyecto de Fisca.\n")
    file.write("Nota 3: Llama al jefe.\n")
    file.write("Nota 4: Recuerdale la reunion con el invercionista.\n")
    file.write("Nota 9: Presentar proyecto.\n")
    file.write("Nota 6: Llega temprano a casa.\n")
    file.write("Nota 7: Te recomiendo leer Amor Invernal.\n")
    file.write("Nota 8: Descansa pronto.\n")
